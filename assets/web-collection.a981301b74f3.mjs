import { renderEntityGrid, renderOrphanRecord } from './web-client-render.f381cd842ce0.mjs';
...
async function renderCollection() {
  ...
  try {
    ...
    console.error(error);
    results.innerHTML = `<div class="empty-state"><span aria-hidden="true">◇</span><h2>Personal collection could not be loaded.</h2><p>${String(error.message ?? error)}</p></div>`;
